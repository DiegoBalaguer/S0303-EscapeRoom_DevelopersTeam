...
public class RoomDisplayDTO {
    ...
    private int getLong(int position) {
        return List.of(8, 25, 15, 15, 10, 8, 100).get(position);
    }
    ...
    public List<PairTextLength> toListHead() {
        ...
        listValues.add(new PairTextLength("DIFFICULTY", getLong(position++)));
    ...
    public List<PairTextLength> toList() {
        ...
        listValues.add(new PairTextLength(name, getLong(position++)));
        listValues.add(new PairTextLength(theme.name(), getLong(position++)));
        listValues.add(new PairTextLength(difficulty.name(), getLong(position++)));
