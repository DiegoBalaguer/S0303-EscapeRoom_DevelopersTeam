...
import dao.connections.ConnectionDAOSqLiteImpl;
...
public class EscapeRoomDAOSqLite implements EscapeRoomDAO {
    private final ConnectionDAOSqLiteImpl connectionDAO;


    public EscapeRoomDAOSqLite() throws DatabaseConnectionException {
        this.connectionDAO = ConnectionDAOSqLiteImpl.getInstance();
    }
